...
\begin{equation}
cost(B) = ||\Xi X - S||^2 + \lambda (\vec{u} \cdot B)
\end{equation}

\noindent with $\vec{u}$ the direction collinear with the gravity throughout the motion.
...
\begin{figure}
  ...
  \begin{subfigure}[b]{0.489\columnwidth}
    ...
    \caption{Gyro corrupted with $|bias|=0.05$.}
  \end{subfigure}
  \begin{subfigure}[b]{0.489\columnwidth}
    \resizebox{\columnwidth}{!}{\input{graph/results2.8s-CF3-CF3Opt-Bias0.1.tex}}
    \caption{Gyro corrupted with $|bias|=0.1$.}
  \end{subfigure}
