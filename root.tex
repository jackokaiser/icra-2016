...
\documentclass[letterpaper, 10 pt, journal, final]{ieeeconf}  % Comment this line out if you need a4paper
...
We set the simulated 3D-landmarks about $3m$ away from the MAV and the drone flies at a speed of around $1m/s$.
We found that setting the frame rate of the simulated camera at 10Hz provides a sufficient optical flow length with the following setup.
Increasing the frame rate above 30Hz decreases the optical flow length and introduce numerical instability for this setup.
