...
In general, we use one frame every 0.3 seconds, even if the camera provides significantly more frames.
...
The camera provides 60fps, but we discard most of the frames and consider only one frame every 0.3 seconds.
